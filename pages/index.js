        ...
        <section className="banner_main">
          <div className="contain">
            <div className="flex">
              <div className="colL">
                <h1>
                  Your final destination for finding high quality and reliable
                  professionals and artisans
                </h1>
                <p>
                  Unlock a World of High Skills and Reliability With Wefitwork.
                  We are your Trusted Partner for Top-Quality Professionals and
                  Artisans!
                </p>
                <form>
                  <input
                    ...
                    className="input"
                    name=""
                    placeholder={"Professional  (eg, Electrician)"}
                ...
                <div className="most_searched_cat">
                  <p>
                    <strong>Most searched categories</strong>
                  </p>
            ...
            <div className="flex">
              <div className="col">
                <div className="inner">
                  ...
                  <h4>Selected</h4>
                  <p>
                    Every WEFITWORK tradesperson has passed up to 12 rigorous
                    checks
                  </p>
                </div>
              </div>
              <div className="col">
                <div className="inner">
                  ...
                  <h4>Tested</h4>
                  <p>
                    Over 6.2 million reviews have been published on WEFITWORK
                  </p>
                </div>
              </div>
              <div className="col">
                <div className="inner">
                  ...
                  <h4>Confirmed</h4>
                  <p>
                    We guarantee WEFITWORK tradespeople's work, claim up to
                    £1000 - <Link href="">T&Cs apply</Link>
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="how_it_works">
          <div className="contain">
            <div className="sec_heading text-center">
              <h2>How it works</h2>
              <p>
                If you’d rather not tackle even minor fixes, call a professional
                for quality plumbing services
              </p>
            </div>
              ...
              <div className="col">
                <div className="inner">
                  <div className="image_new">
                    <img
                      src="/images/corporate-woman-looking-phone.jpg"
                      alt=""
                    />
                  </div>
                  <div className="cntnt">
                    <h4>Search</h4>
                    <p>
                      If you’d rather not tackle even minor fixes, call a
                      professional for quality plumbing services
                    </p>
